...
linear_extrude(1){
  ...
  translate(){
    ...
    polygon(polyround(beam_chain(radiiPoints,offset1=0.02, offset2=-0.02),20));
  }
  ...
  translate([0,-7*2,0]){
    radiiPoints=beamPoints(2,1);
    polygon(polyround(beam_chain(radiiPoints,offset1=0.5, offset2=-0.5),20));
  }
